...
func newWalker(cwd string, writeDirs []string, evalFunc func(string, string, []string) bool) *walker {
	return &walker{cwd: cwd, writeDirs: writeDirs, evalFunc: evalFunc}
}
...
func (w *walker) checkCall(call *syntax.CallExpr) bool {
	...
	// Dispatch to registered checker.
